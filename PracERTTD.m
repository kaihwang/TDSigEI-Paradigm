function data_mat = PracERTTD(subjname, sessions, motor_mapping)
% Psychtoolbox script for the event related version of TDSigEI paradigm. This sone is for behav testing.
% Usage PracERTTD(subjname, sessions, motor_mapping)
%
...
block_num = 2;
trial_num_pbl = 9;
numb_of_targets = 3; %numb of hits
%prac_trial_num=1;

%setup trial timing
instruction_on_screen_time = 1;
inter_block_interval = 7;
initial_wait_time = 2;
...
delay_times = [2 2 2 2 2 2 2 2 2]; %time of delay between stimulus (ITI)
